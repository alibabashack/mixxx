...
class PlaylistDAO : public QObject, public virtual DAO {
  ...
  public:
    ...
    [[nodiscard]] bool isPlaylistLocked(const int playlistId) const;
    ...
    [[nodiscard]] unsigned int playlistCount() const;
    // Get all playlist ids and names of a specific type
    [[nodiscard]] QList<QPair<int, QString>> getPlaylists(const HiddenType hidden) const;
    // Find out the name of the playlist at the given Id
    [[nodiscard]] QString getPlaylistName(const int playlistId) const;
    // Get the playlist id by its name
    [[nodiscard]] int getPlaylistIdFromName(const QString& name) const;
    ...
    [[nodiscard]] int getPlaylistId(const int index) const;
    [[nodiscard]] QList<TrackId> getTrackIds(const int playlistId) const;
    // Returns true if the playlist with playlistId is hidden
    [[nodiscard]] bool isHidden(const int playlistId) const;
    // Returns the HiddenType of playlistId
    [[nodiscard]] HiddenType getHiddenType(const int playlistId) const;
    // Returns the maximum position of the given playlist
    [[nodiscard]] int getMaxPosition(const int playlistId) const;
    ...
    [[nodiscard]] int getPreviousPlaylist(const int currentPlaylistId, HiddenType hidden) const;
    ...
    [[nodiscard]] int tracksInPlaylist(const int playlistId) const;
    ...
    [[nodiscard]] bool isTrackInPlaylist(TrackId trackId, const int playlistId) const;
